...
using  Apartment_back.Efc;
using Apartment_back.Efc.Models;

namespace Apartment_back.Efc.Controllers;
...
public class ExpensesController : ControllerBase
{
    ...
    public async Task<ActionResult<Expense>> PutExpense(int id, Expense expense)
    {
        ...
        storedExpense.Id_apartment = expense.Id_apartment;
        storedExpense.Price = expense.Price;
        storedExpense.Location = expense.Location;
